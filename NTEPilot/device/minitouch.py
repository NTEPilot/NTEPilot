...
from utils.decorators import cached_property, del_cached_property, has_cached_property
from utils.timer import Timer
from .connection import Connection
from .utils import RETRY_TRIES, handle_adb_error, handle_unknown_host_service, retry_sleep
...
def retry(func):
    ...
    def retry_wrapper(self, *args, **kwargs):
        ...
        for _ in range(RETRY_TRIES):
            ...
            except (MinitouchNotInstalledError, MinitouchOccupiedError) as e:
                logger.error(e)
            ...
            try:
                ...
                if retry_timeout.reached:
                    raise MinitouchOccupiedError(
                        f'Timeout when connecting to minitouch: {e}'
                    )
                else:
                    time.sleep(0.2)
                    continue
